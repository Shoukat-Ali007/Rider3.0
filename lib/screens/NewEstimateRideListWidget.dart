...
import 'package:gb_Rides/screens/RideDetailScreen.dart';
                        ...
                        if (snap.hasData) {
                          ...
                          if (data.length != 0) {
                            ...
                            return rideRequestData != null
                                ...
                                // :SizedBox();
                                :data[0].status== NEW_RIDE_REQUESTED?BookingWidget(id: rideRequestId == 0 ? widget.id : rideRequestId, isLast: true):loaderWidget();
                          } else {
                            return SizedBox();
                          }
                        } else {
